<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="sm:px-6 lg:px-8 bg-sky-400">
        <div class="flex justify-end h-16 ">
            <div class="flex">
                <!-- Logo -->
              <div class="flex items-center">
                    <x-nav-link class="text-2xl absolute left-5">
                        {{ __('Объявления.ru') }}
                    </x-nav-link>
                </div>
                <!-- Navigation Links -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-sky-400">
        <div class="pt-2 pb-3 space-y-1 ">
            <x-responsive-nav-link :href="route('board.index')" :active="request()->routeIs('board.index')">
            {{ __('Лента') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('my')" :active="request()->routeIs('my')">
            {{ __('Мои объявления') }}
            </x-responsive-nav-link>
